...
class DevelopmentConfig(Config):
    DEBUG = True
    ASSETS_DEBUG = True
    # print(')>>>>>>>>>>>>>>>>>>>S '+ os.environ.get('DEV_DATABASE_URL', 'sqlite:///' + os.path.join(basedir, 'data-dev.sqlite')))?host=192.168.64.2?port=3306
    # SQLALCHEMY_DATABASE_URI = os.environ.get('DEV_DATABASE_URL','sqlite:///' + os.path.join(basedir, 'data-dev.sqlite')) 
    SQLALCHEMY_DATABASE_URI = os.environ.get('DEV_DATABASE_URL','mysql+pymysql://kaywize:kaywize@192.168.64.2:3306/playpodcast')
